...
<header id="header">
    ...
    <nav id="nav">
        ...
        <a href="#" <?php if ( $active == 2 ) {echo "class='current-page-item'"; }?> >Technology</a>
        <a href="#" <?php if ( $active == 3 ) {echo "class='current-page-item'"; }?> >Classification</a>
        ...
        <a href="#" <?php if ( $active == 7 ){ echo "class='current-page-item'"; }?> >Business</a>
        <a href="#" <?php if ( $active == 8 ){ echo "class='current-page-item'"; }?> >Contact us</a>
    </nav>
</header>