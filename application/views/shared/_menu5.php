     ...
     <ul class="nav nav-list">
        ...
        <li class="<?php if($current == 'master' ) echo $active; ?>">
            ...
            <ul class="submenu">
                ...
                <li class="<?php if( $current_sub == 'vat' ) echo 'active'; ?>" >
                    <a href="#" class="dropdown-toggle">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Article Type
                        <b class="arrow fa fa-angle-down"></b>
                ...
                <li class="<?php if( $current_sub == 'author' ) echo 'active'; ?>" >
                    <a href="#" class="dropdown-toggle">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Author
                        <b class="arrow fa fa-angle-down"></b>
                    ...
                    <ul class="submenu">                                    
                        <li class="">
                            <a href="<?php echo MODE; ?>/author/register">
                                <i class="menu-icon fa fa-plus purple"></i>
                                Add Author
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="">
                            <a href="<?php echo MODE; ?>/author/author_view">
                                <i class="menu-icon fa fa-eye pink"></i>
                                View Authors
                            </a>
                            <b class="arrow"></b>
            ...
            <ul class="submenu">
                ...
                <li class="<?php if( $current_sub == 'view_article' ) echo 'active'; ?>">
                    <a href="<?php echo MODE; ?>/articles/article_view" >          
                        <i class="menu-icon fa fa-caret-right"></i>Article list view
                    </a>
                    <b class="arrow"></b>
                </li>
                <li class="<?php if( $current_sub == 'vda' ) echo 'active'; ?>">
                    <a href="<?php echo MODE; ?>/articles/deleted_articles" >          
                        <i class="menu-icon fa fa-caret-right"></i> Deleted Articles
                    </a>
                    <b class="arrow"></b>
                </li>
