...
<!--         <script src="<?php echo ASSEST_PATH_ADMIN; ?>/js/jquery.ui.touch-punch.min.js"></script> -->
        ...
        <script src="<?php echo ASSEST_PATH_ADMIN; ?>/js/spinbox.min.js"></script>
    ...
    */
    ...
    if ( typeof jQuery.ui !== 'undefined' && ace.vars['webkit'] ) {
        ...
        if (typeof jQuery.ui !== 'undefined') enableImageResize();
            ...
            $.getScript("<?php echo ASSEST_PATH_ADMIN; ?>/js/jquery-ui.custom.min.js", function(data, textStatus, jqxhr) {
                enableImageResize()
            });
        }
        */
